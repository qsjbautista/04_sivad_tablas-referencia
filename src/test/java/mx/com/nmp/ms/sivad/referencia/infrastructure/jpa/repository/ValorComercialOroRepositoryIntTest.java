...
public class ValorComercialOroRepositoryIntTest {
    ...
    private static final BigDecimal PRECIO_ORO_NUEVO_1 = new BigDecimal(50.250).setScale(3, BigDecimal.ROUND_HALF_UP);
    private static final BigDecimal PRECIO_ORO_NUEVO_2 = new BigDecimal(60.250).setScale(3, BigDecimal.ROUND_HALF_UP);
    private static final BigDecimal PRECIO_ORO_NUEVO_3 = new BigDecimal(70.250).setScale(3, BigDecimal.ROUND_HALF_UP);
