 ...
 * @author mmarquez
 */
public class CertificadoNoEncontradoException extends RuntimeException {


    private static final long serialVersionUID = -6218590165730978131L;
     ...
     */
    public CertificadoNoEncontradoException(String msg, Class<?> entidad) {
        super(msg);
