...
public class BatchConfiguration {
    ...
    @Bean
    public ItemProcessor<PrecioCorteDetalleBatch, Diamante> valorComercialDiamanteProcessor(CalculosPrecioDiamanteRepository repository) {
        return new ValorComercialDiamanteProcessor(repository);
    }
